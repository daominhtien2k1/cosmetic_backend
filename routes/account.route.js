...
accountRouter.post("/set_request_friend", auth, accountsController.set_request_friend);
accountRouter.get("/get_list_friend_request_received", auth, accountsController.get_list_friend_request_received);
accountRouter.post("/del_friend", auth, accountsController.del_friend);
accountRouter.get("/get_list_unknown_people", auth, accountsController.get_list_unknown_people);
accountRouter.get("/get_list_friends", auth, accountsController.get_list_friends);
...
accountRouter.get("/get_blocked_account", auth, accountsController.get_block_account);
